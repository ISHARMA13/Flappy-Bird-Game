...
bird_down_flap = pygame.image.load('assets/bluebird-down-flap.png').convert_alpha()
bird_mid_flap = pygame.image.load('assets/bluebird-mid-flap.png').convert_alpha()
bird_up_flap = pygame.image.load('assets/bluebird-up-flap.png').convert_alpha()
...
# bird_surface = pygame.image.load('assets/bluebird-mid-flap.png').convert_alpha()
